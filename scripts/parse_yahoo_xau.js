...
const maxAge=marketBreak ? 90*60*1000 : 20*60*1000;
...
console.log(`Loaded ${trimmed.length} unique closed XAUUSD M5 bars; latest=${new Date(latest).toISOString()}; marketBreak=${marketBreak}`);